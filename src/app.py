...
def compile_stats(games, goals, assists, pens_att, pens_made, progressive_carries):  
    ...
    if st.session_state["pens_made"] == 0:
        return  "> " + st.session_state["jugador"] + " ha marcado " + str(goals) + " goles en " + str(games) + " partidos, asistiendo " + str(assists) + " veces, ha ejecutado " + str(pens_att) + " penaltis, de los cuales no marcado ninguno y los goles marcados en jugada han sido " + str(goals_pens) + ".\n **El resultado de los goles esperados del jugador es de {:.2f} goles por temporada.**".format(prediction[0])
    else:
        return "> "+st.session_state["jugador"]+" ha marcado "+goals+" goles en "+games+" partidos, asistiendo "+assists+" veces, ha ejecutado "+pens_att+" penaltis, de los cuales ha marcado "+pens_made+" y los goles marcados en jugada han sido "+goals_pens+".\n **El resultado de los goles esperados del jugador es de {:.2f} goles por temporada.**".format(prediction[0])
